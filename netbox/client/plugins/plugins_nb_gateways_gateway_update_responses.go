...
func (o *PluginsNbGatewaysGatewayUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPluginsNbGatewaysGatewayUpdateOK()
...
func NewPluginsNbGatewaysGatewayUpdateOK() *PluginsNbGatewaysGatewayUpdateOK {
	return &PluginsNbGatewaysGatewayUpdateOK{}
}
...
// Code gets the status code for the plugins nb gateways gateway update o k response
func (o *PluginsNbGatewaysGatewayUpdateOK) Code() int {
	return 200
}

func (o *PluginsNbGatewaysGatewayUpdateOK) Error() string {
	return fmt.Sprintf("[PUT /plugins/nb-gateways/gateway/{id}/][%d] pluginsNbGatewaysGatewayUpdateOK  %+v", 200, o.Payload)
}

func (o *PluginsNbGatewaysGatewayUpdateOK) String() string {
	return fmt.Sprintf("[PUT /plugins/nb-gateways/gateway/{id}/][%d] pluginsNbGatewaysGatewayUpdateOK  %+v", 200, o.Payload)
}

func (o *PluginsNbGatewaysGatewayUpdateOK) GetPayload() *models.Gateway {
	return o.Payload
}

func (o *PluginsNbGatewaysGatewayUpdateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
