...
func (o *PluginsNbGatewaysGatewayCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewPluginsNbGatewaysGatewayCreateCreated()
...
func NewPluginsNbGatewaysGatewayCreateCreated() *PluginsNbGatewaysGatewayCreateCreated {
	return &PluginsNbGatewaysGatewayCreateCreated{}
}
...
func (o *PluginsNbGatewaysGatewayCreateCreated) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this plugins nb gateways gateway create created response has a 3xx status code
func (o *PluginsNbGatewaysGatewayCreateCreated) IsRedirect() bool {
	return false
}
...
func (o *PluginsNbGatewaysGatewayCreateCreated) IsCode(code int) bool {
	return code == 201
}
...
func (o *PluginsNbGatewaysGatewayCreateCreated) String() string {
	return fmt.Sprintf("[POST /plugins/nb-gateways/gateway/][%d] pluginsNbGatewaysGatewayCreateCreated  %+v", 201, o.Payload)
}

func (o *PluginsNbGatewaysGatewayCreateCreated) GetPayload() *models.Gateway {
	return o.Payload
}

func (o *PluginsNbGatewaysGatewayCreateCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
