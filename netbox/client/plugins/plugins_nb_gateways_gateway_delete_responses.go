...
func (o *PluginsNbGatewaysGatewayDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewPluginsNbGatewaysGatewayDeleteNoContent()
...
func NewPluginsNbGatewaysGatewayDeleteNoContent() *PluginsNbGatewaysGatewayDeleteNoContent {
	return &PluginsNbGatewaysGatewayDeleteNoContent{}
}
...
func (o *PluginsNbGatewaysGatewayDeleteNoContent) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this plugins nb gateways gateway delete no content response has a 3xx status code
func (o *PluginsNbGatewaysGatewayDeleteNoContent) IsRedirect() bool {
	return false
}
...
func (o *PluginsNbGatewaysGatewayDeleteNoContent) IsCode(code int) bool {
	return code == 204
}

// Code gets the status code for the plugins nb gateways gateway delete no content response
func (o *PluginsNbGatewaysGatewayDeleteNoContent) Code() int {
	return 204
}

func (o *PluginsNbGatewaysGatewayDeleteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /plugins/nb-gateways/gateway/{id}/][%d] pluginsNbGatewaysGatewayDeleteNoContent ", 204)
}

func (o *PluginsNbGatewaysGatewayDeleteNoContent) String() string {
	return fmt.Sprintf("[DELETE /plugins/nb-gateways/gateway/{id}/][%d] pluginsNbGatewaysGatewayDeleteNoContent ", 204)
}

func (o *PluginsNbGatewaysGatewayDeleteNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
