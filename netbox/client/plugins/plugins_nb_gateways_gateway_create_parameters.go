...
// NewPluginsNbGatewaysGatewayCreateParams creates a new PluginsNbGatewaysGatewayCreateParams object,
...
func NewPluginsNbGatewaysGatewayCreateParams() *PluginsNbGatewaysGatewayCreateParams {
	return &PluginsNbGatewaysGatewayCreateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPluginsNbGatewaysGatewayCreateParamsWithTimeout creates a new PluginsNbGatewaysGatewayCreateParams object
...
// NewPluginsNbGatewaysGatewayCreateParamsWithContext creates a new PluginsNbGatewaysGatewayCreateParams object
...
// NewPluginsNbGatewaysGatewayCreateParamsWithHTTPClient creates a new PluginsNbGatewaysGatewayCreateParams object
...
func (o *PluginsNbGatewaysGatewayCreateParams) WithDefaults() *PluginsNbGatewaysGatewayCreateParams {
	o.SetDefaults()
	return o
}
...
func (o *PluginsNbGatewaysGatewayCreateParams) WithTimeout(timeout time.Duration) *PluginsNbGatewaysGatewayCreateParams {
...
func (o *PluginsNbGatewaysGatewayCreateParams) WithContext(ctx context.Context) *PluginsNbGatewaysGatewayCreateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the plugins nb gateways gateway create params
func (o *PluginsNbGatewaysGatewayCreateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the plugins nb gateways gateway create params
func (o *PluginsNbGatewaysGatewayCreateParams) WithHTTPClient(client *http.Client) *PluginsNbGatewaysGatewayCreateParams {
...
func (o *PluginsNbGatewaysGatewayCreateParams) WithData(data *models.WritableGateway) *PluginsNbGatewaysGatewayCreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the plugins nb gateways gateway create params
func (o *PluginsNbGatewaysGatewayCreateParams) SetData(data *models.WritableGateway) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *PluginsNbGatewaysGatewayCreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
