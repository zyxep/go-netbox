...
func (o *PluginsNbGatewaysGatewayPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPluginsNbGatewaysGatewayPartialUpdateOK()
...
func NewPluginsNbGatewaysGatewayPartialUpdateOK() *PluginsNbGatewaysGatewayPartialUpdateOK {
	return &PluginsNbGatewaysGatewayPartialUpdateOK{}
}
...
func (o *PluginsNbGatewaysGatewayPartialUpdateOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this plugins nb gateways gateway partial update o k response has a 3xx status code
func (o *PluginsNbGatewaysGatewayPartialUpdateOK) IsRedirect() bool {
	return false
}
...
func (o *PluginsNbGatewaysGatewayPartialUpdateOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the plugins nb gateways gateway partial update o k response
func (o *PluginsNbGatewaysGatewayPartialUpdateOK) Code() int {
	return 200
}

func (o *PluginsNbGatewaysGatewayPartialUpdateOK) Error() string {
	return fmt.Sprintf("[PATCH /plugins/nb-gateways/gateway/{id}/][%d] pluginsNbGatewaysGatewayPartialUpdateOK  %+v", 200, o.Payload)
}

func (o *PluginsNbGatewaysGatewayPartialUpdateOK) String() string {
	return fmt.Sprintf("[PATCH /plugins/nb-gateways/gateway/{id}/][%d] pluginsNbGatewaysGatewayPartialUpdateOK  %+v", 200, o.Payload)
}

func (o *PluginsNbGatewaysGatewayPartialUpdateOK) GetPayload() *models.Gateway {
	return o.Payload
}

func (o *PluginsNbGatewaysGatewayPartialUpdateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
