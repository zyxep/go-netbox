...
func (o *PluginsNbGatewaysGatewayBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPluginsNbGatewaysGatewayBulkPartialUpdateOK()
...
func NewPluginsNbGatewaysGatewayBulkPartialUpdateOK() *PluginsNbGatewaysGatewayBulkPartialUpdateOK {
	return &PluginsNbGatewaysGatewayBulkPartialUpdateOK{}
}
...
func (o *PluginsNbGatewaysGatewayBulkPartialUpdateOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the plugins nb gateways gateway bulk partial update o k response
func (o *PluginsNbGatewaysGatewayBulkPartialUpdateOK) Code() int {
	return 200
}

func (o *PluginsNbGatewaysGatewayBulkPartialUpdateOK) Error() string {
	return fmt.Sprintf("[PATCH /plugins/nb-gateways/gateway/][%d] pluginsNbGatewaysGatewayBulkPartialUpdateOK  %+v", 200, o.Payload)
}

func (o *PluginsNbGatewaysGatewayBulkPartialUpdateOK) String() string {
	return fmt.Sprintf("[PATCH /plugins/nb-gateways/gateway/][%d] pluginsNbGatewaysGatewayBulkPartialUpdateOK  %+v", 200, o.Payload)
}

func (o *PluginsNbGatewaysGatewayBulkPartialUpdateOK) GetPayload() *models.Gateway {
	return o.Payload
}

func (o *PluginsNbGatewaysGatewayBulkPartialUpdateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
