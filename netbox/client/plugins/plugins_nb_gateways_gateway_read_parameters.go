...
// NewPluginsNbGatewaysGatewayReadParams creates a new PluginsNbGatewaysGatewayReadParams object,
...
func NewPluginsNbGatewaysGatewayReadParams() *PluginsNbGatewaysGatewayReadParams {
	return &PluginsNbGatewaysGatewayReadParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPluginsNbGatewaysGatewayReadParamsWithTimeout creates a new PluginsNbGatewaysGatewayReadParams object
...
// NewPluginsNbGatewaysGatewayReadParamsWithContext creates a new PluginsNbGatewaysGatewayReadParams object
...
// NewPluginsNbGatewaysGatewayReadParamsWithHTTPClient creates a new PluginsNbGatewaysGatewayReadParams object
...
func (o *PluginsNbGatewaysGatewayReadParams) WithDefaults() *PluginsNbGatewaysGatewayReadParams {
	o.SetDefaults()
	return o
}
...
func (o *PluginsNbGatewaysGatewayReadParams) WithTimeout(timeout time.Duration) *PluginsNbGatewaysGatewayReadParams {
...
func (o *PluginsNbGatewaysGatewayReadParams) WithContext(ctx context.Context) *PluginsNbGatewaysGatewayReadParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the plugins nb gateways gateway read params
func (o *PluginsNbGatewaysGatewayReadParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the plugins nb gateways gateway read params
func (o *PluginsNbGatewaysGatewayReadParams) WithHTTPClient(client *http.Client) *PluginsNbGatewaysGatewayReadParams {
...
func (o *PluginsNbGatewaysGatewayReadParams) WithID(id int64) *PluginsNbGatewaysGatewayReadParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the plugins nb gateways gateway read params
func (o *PluginsNbGatewaysGatewayReadParams) SetID(id int64) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *PluginsNbGatewaysGatewayReadParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
